...
ALTER TABLE `games` ADD `option_name` VARCHAR(100) NOT NULL DEFAULT '' AFTER `name`, ADD `option_name_plural` VARCHAR(100) NOT NULL DEFAULT '' AFTER `option_name_plural`;
