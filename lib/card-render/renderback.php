...
if ($card_id > 0) {
	...
	$qr_fname = dirname(dirname(dirname(__FILE__)))."/downloads/images/".$card['card_id']."_qr.png";
	QRcode::png("http://".$_SERVER['SERVER_NAME']."/check/".$card['issuer_card_id'], $qr_fname, 'M', 4, 2);
