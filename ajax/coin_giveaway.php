...
if ($thisuser) {
	...
	if (mysql_numrows($r) > 0) {
		...
		$q = "INSERT INTO webwallet_transactions SET currency_mode='beta', transaction_desc='giveaway', amount=100000000000, user_id='".$thisuser['user_id']."', block_id='".(last_block_id($thisuser['currency_mode'])+1)."', address_id='".user_address_id($thisuser['user_id'], false)."', time_created='".time()."';";
		$r = run_query($q);
