...
if (!empty($_REQUEST['color']) && $_REQUEST['color'] == "dark") $digits = imagecreatefrompng(AppSettings::srcPath()."/images/card_images/digits_dark.png");
else $digits = imagecreatefrompng(AppSettings::srcPath()."/images/card_images/digits.png");
