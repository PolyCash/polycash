		...
		if ($new_game_perm) {
			...
			if ($module_ok) {
				...
				if (!$setup_error) {
					...
					list($initial_game_def_hash, $initial_game_def) = GameDefinition::export_game_definition($game, "actual", $show_internal_params, false);
					...
					list($final_game_def_hash, $final_game_def) = GameDefinition::export_game_definition($game, "actual", $show_internal_params, false);
		...
		if ($action == "switch") {
			...
			if ($action == "fetch") {
				...
				if ($action == "load_gde") {
					...
					list($initial_defined_game_def_hash, $initial_defined_game_def) = GameDefinition::export_game_definition($game, "defined", $show_internal_params, false);
					...
					list($final_defined_game_def_hash, $final_defined_game_def) = GameDefinition::export_game_definition($game, "defined", $show_internal_params, false);
