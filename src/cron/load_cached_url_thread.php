...
if ($app->running_as_admin()) {
	...
	$unprocessed_urls = $app->run_limited_query("SELECT * FROM cached_urls WHERE time_fetched IS NULL ORDER BY cached_url_id ASC LIMIT ".((int)$max_urls_per_execution)." OFFSET ".((int)($process_index*$max_urls_per_execution)).";");
	$keeplooping = true;
