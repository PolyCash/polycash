		...
		if ($info->rowCount() > 0) {
			...
			while ($db_gde = $gde_r->fetch()) {
				...
				$event = array(
					...
					"event_outcome_block" => isset($db_gde['event_outcome_block']) ? $db_gde['event_outcome_block'] : null,
					...
					"event_determined_from_time" => isset($db_gde['event_determined_from_time']) ? $db_gde['event_determined_from_time'] : null,
					"event_determined_to_time" => isset($db_gde['event_determined_to_time']) ? $db_gde['event_determined_to_time'] : null,
