...
class BlockchainVerifier {
	public static function verifyBlock(&$app, $blockchain_id, $block_id) {
		...
		$tx_wrong_ios_out = $app->run_query("SELECT t.position_in_block, t.tx_hash, t.num_outputs, COUNT(*) FROM transaction_ios io JOIN transactions t ON io.create_transaction_id=t.transaction_id WHERE t.block_id=:block_id AND t.blockchain_id=:blockchain_id GROUP BY io.create_transaction_id HAVING COUNT(*) != t.num_outputs;", [
			'block_id' => $block_id,
			'blockchain_id' => $blockchain_id
		]);
