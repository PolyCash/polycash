...
Next, configure cron to poll polycash every minute. This keeps polycash in sync with your coin daemon. Add these lines to your /etc/crontab:
```
* * * * * root /usr/bin/php /var/www/html/polycash/cron/minutely.php <CRON_KEY_STRING>
```
